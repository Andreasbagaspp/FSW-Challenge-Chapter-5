...
option.forEach(function (opt) {
  opt.addEventListener("click", function () {
    ...
    getResult = "";
    if (
      (player1Option === "batu" && comOpt === "gunting") ||
      (player1Option === "kertas" && comOpt === "batu") ||
      (player1Option === "gunting" && comOpt === "kertas")
    ) {
      result.innerHTML = "PLAYER 1 WIN";
      result.style = resultStyleWin;
    } else if (
      (comOpt === "batu" && player1Option === "gunting") ||
      (comOpt === "kertas" && player1Option === "batu") ||
      (comOpt === "gunting" && player1Option === "kertas")
    ) {
